...
async function execute(_client, database, interaction) {
    await utils.validateServerInfo(interaction, database, true, true, async (_serverInfo) => {
        await interaction.editReply('This command is now deprecated, please use slash commands.');
...
module.exports = {
    ...
    info: { 
		name: 'prefix',
        description: 'Prefix of the commands used by this bot',
		func: execute
	}
};